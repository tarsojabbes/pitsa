   ...
   @Autowired
    ...
    public class SaborExcluirServiceTests {
        ...
        public void testSaborExcluidoDeRepositorioComMultiplosSaboresSalvos() {
            ...
            saborExcluirService.excluir(estabelecimento.getCodigoDeAcesso(), saborSalvo.getId());
        ...
        public void testExclusaoDoUnicoSaborSalvo() {
            ...
            saborExcluirService.excluir(estabelecimento.getCodigoDeAcesso(), sabor.getId());
        ...
        public void testTentaExcluirSaborInexistente() {
            ...
            assertEquals(1, saborRepository.findAll().size());
            assertThrows(MercadoFacilException.class, () -> saborExcluirService.excluir(estabelecimento.getCodigoDeAcesso(), sabor.getId() + 1L));
            assertEquals(1, saborRepository.findAll().size());
    ...
    public class SaborListarServiceTests {
        ...
        public void testListaSaborExistentePorID() {
            ...
            List<Sabor> saborList = saborListarService.listar(novoSabor.getId(), estabelecimento.getId());
        ...
        public void testListaInexistentePorID() {
            ...
            //saborExcluirService.excluir(estabelecimento.getCodigoDeAcesso(), sabor.getId());
            saborRepository.deleteAll();
            assertThrows(MercadoFacilException.class, () -> saborListarService.listar(sabor.getId() + 1L, estabelecimento.getId()));
